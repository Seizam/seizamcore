...
$messages['en'] = array(
    ...
    'po-help-read' => 'Click one radio button to select the group of user allowed to read this page. Eg: Select "<b>{{int:po-owner}}</b>" to forbid access to everyone.',
    'po-whocan-edit' => 'Who can edit?',
    'po-help-edit' => 'Click one radio button to select the group of user allowed to edit this page. Eg: Select "<b>{{int:po-everyone}}</b>" to allow the entire world.',
...
$messages['fr'] = array(
    ...
    'po-help-read' => 'Cliquez un boutton radio pour sélectionner le groupe d\'utilisateurs autorisé à consulter cette page. Ex : Sélectionnez "<b>{{int:po-owner}}</b>" pour interdire l\'accès à tout le monde.',
    'po-whocan-edit' => 'Qui peut modifier ?',
    'po-help-edit' => 'Cliquez un boutton radio pour sélectionner le groupe d\'utilisateurs autorisé à modifier cette page. Ex : Sélectionnez "<b>{{int:po-everyone}}</b>" pour autorisé la terre entière.',
    'po-whocan-upload' => 'Qui peut importer ?',
    'po-help-upload' => 'Cliquez un boutton radio pour sélectionner le groupe d\'utilisateurs autorisé à ré-importer ce fichier. Ex : Sélectionnez ""<b>{{int:po-artist}}</b>" pour autorisé uniquement les abonnés à Seizam.',
