...
$messages['en'] = array(
    ...
    'optional-field' => 'This field is <b>optional</b>.',
    ...
    'sz-slideshow0-src' => '{{STYLEPATH}}/skinzam/content/en/1ps.jpg',
    'sz-slideshow1-src' => '{{STYLEPATH}}/skinzam/content/en/2ps.jpg',
    'sz-slideshow2-src' => '{{STYLEPATH}}/skinzam/content/en/3ps.jpg',
    'sz-slideshow3-src' => '{{STYLEPATH}}/skinzam/content/en/4ps.jpg',
    'sz-slideshow4-src' => '{{STYLEPATH}}/skinzam/content/en/5ps.jpg',
    'sz-slideshow5-src' => '{{STYLEPATH}}/skinzam/content/en/6ps.jpg',
    'sz-slideshow6-src' => '{{STYLEPATH}}/skinzam/content/en/7ps.jpg',
    'sz-slideshow7-src' => '{{STYLEPATH}}/skinzam/content/en/8ps.jpg',
    'sz-slideshow8-src' => '{{STYLEPATH}}/skinzam/content/en/9ps.jpg',
    'sz-slideshow9-src' => '{{STYLEPATH}}/skinzam/content/en/0ps.jpg',
    
    'sz-slideshow0' => 'The Liberty for Creation: ',
    'sz-slideshow1' => 'The Flexibility of WikiText: ',
    'sz-slideshow2' => 'The Space to Store: ',
    'sz-slideshow3' => 'The Reach through Widgets: ',
    'sz-slideshow4' => 'The Absence of Pollution: ',
    'sz-slideshow5' => 'The Depth by WikiPlaces: ',
    'sz-slideshow6' => 'The Bounty of Multilinguism: ',
    'sz-slideshow7' => 'The Openness towards Collaboration: ',
    'sz-slideshow8' => 'The Choice of Licenses: ',
    'sz-slideshow9' => 'The Belief in Free Thinking: ',
    
    'sz-slideshow0-href' => '{{canonicalurl:Project:Liberty for Creation}}',
    'sz-slideshow1-href' => '{{canonicalurl:Project:Flexibility of WikiText}}',
    'sz-slideshow2-href' => '{{canonicalurl:Project:Space to Store}}',
    'sz-slideshow3-href' => '{{canonicalurl:Project:Reach through Widgets}}',
    'sz-slideshow4-href' => '{{canonicalurl:Project:Absence of Pollution}}',
    'sz-slideshow5-href' => '{{canonicalurl:Project:Depth by WikiPlaces}}',
    'sz-slideshow6-href' => '{{canonicalurl:Bounty of Multilinguism}}',
    'sz-slideshow7-href' => '{{canonicalurl:Openness towards Collaboration}}',
    'sz-slideshow8-href' => '{{canonicalurl:Choice of Licenses}}',
    'sz-slideshow9-href' => '{{canonicalurl:Belief in Free Thinking}}',
    
    'sz-slideshow0-body' => 'Publish your art online, whatever your disciplines, whatever your vision.',
    'sz-slideshow1-body' => 'Design the look of your pages with precision thanks to Wikipedia\'s technology.',
    'sz-slideshow2-body' => 'Host and share your files. Keep track of your work with the revision history.',
    'sz-slideshow3-body' => 'From Vimeo to Twitter, insert and combine your favorite services on your pages.',
    'sz-slideshow4-body' => 'No advertisement, no spam. Nothing here will ever spoil your work.',
    'sz-slideshow5-body' => 'Be the architect of your own website. Keep your pages short and artful.',
    'sz-slideshow6-body' => 'Write and translate your work in any language. Touch every culture.',
    'sz-slideshow7-body' => 'Share your creativity with the world, let it share its creativity back.',
...
$messages['fr'] = array(
    ...
    'sz-slideshow0-src' => '{{STYLEPATH}}/skinzam/content/fr/1ps.jpg',
    'sz-slideshow1-src' => '{{STYLEPATH}}/skinzam/content/fr/2ps.jpg',
    'sz-slideshow2-src' => '{{STYLEPATH}}/skinzam/content/fr/3ps.jpg',
    'sz-slideshow3-src' => '{{STYLEPATH}}/skinzam/content/fr/4ps.jpg',
    'sz-slideshow4-src' => '{{STYLEPATH}}/skinzam/content/fr/5ps.jpg',
    'sz-slideshow5-src' => '{{STYLEPATH}}/skinzam/content/fr/6ps.jpg',
    'sz-slideshow6-src' => '{{STYLEPATH}}/skinzam/content/fr/7ps.jpg',
    'sz-slideshow7-src' => '{{STYLEPATH}}/skinzam/content/fr/8ps.jpg',
    'sz-slideshow8-src' => '{{STYLEPATH}}/skinzam/content/fr/9ps.jpg',
    
    'sz-slideshow0' => 'L\'espace pour la création : ',
    'sz-slideshow1' => 'La flexibilité du WikiText : ',
    'sz-slideshow2' => 'L\'espace de stockage : ',
    'sz-slideshow3' => 'La portée des widgets : ',
    'sz-slideshow4' => 'L\'absence de pollution : ',
    'sz-slideshow5' => 'La puissance des WikiPlaces : ',
    'sz-slideshow6' => 'La richesse du multilinguisme : ',
    'sz-slideshow7' => 'L\'ouverture vers la collaboration : ',
    'sz-slideshow8' => 'Le choix des licences : ',
    'sz-slideshow9' => 'La croyance dans la pensée libre : ',
    ...
    'sz-slideshow1-body' => 'Concevez l\'apparence de vos pages avec précision grâce à la technologie de Wikipedia.',
