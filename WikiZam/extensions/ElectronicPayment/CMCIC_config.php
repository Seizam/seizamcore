...
define("CMCIC_URLOK", "http://localhost/WikiZam/index.php?title=Special:ElectronicPayment&status=success");
define("CMCIC_URLKO", "http://localhost/WikiZam/index.php?title=Special:ElectronicPayment&status=fail");
