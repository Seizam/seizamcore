 ...
 * @ingroup Upload
 */
class SpecialUploadPlace extends SpecialPage {
	/**
	...
	public function __construct( $request = null ) {
		...
		parent::__construct( 'UploadPlace', WP_SUBSCRIBERS_USER_GROUP );
	 ...
	 * @return UploadPlaceForm
	 */
	protected function getUploadForm( $message = '', $sessionKey = '', $hideIgnoreWarning = false ) {
		global $wgOut;

		# Initialize form
		$form = new UploadPlaceForm( array(
 ...
 */
class UploadPlaceForm extends HTMLForm {
	protected $mWatch;
 ...
 */
class UploadPlaceSourceField extends HTMLTextField {
