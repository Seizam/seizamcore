...
CREATE TABLE IF NOT EXISTS `wp_page` (
  `wppa_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
  `wppa_wpw_id` int(10) unsigned NOT NULL COMMENT 'Foreign key: associated WikiPlace',
  `wppa_page_id` int(10) unsigned NOT NULL COMMENT 'Foreign key: associated MediaWiki''s page',
  PRIMARY KEY (`wppa_id`),
