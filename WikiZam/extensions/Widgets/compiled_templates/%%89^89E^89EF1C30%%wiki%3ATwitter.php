<?php /* Smarty version 2.6.18-dev, created on 2012-06-14 02:04:02
...
<div class="twitter<?php if (isset ( $this->_tpl_vars['right'] )): ?> right<?php elseif (isset ( $this->_tpl_vars['left'] )): ?> left<?php endif; ?>"><?php echo smarty_function_counter(array('name' => 'twittercounter','assign' => 'twitblogincluded'), $this);?>
<?php if ($this->_tpl_vars['twitblogincluded'] == 1): ?><script charset="utf-8" src="http://widgets.twimg.com/j/2/widget.js"></script><?php endif; ?>
<script>
new TWTR.Widget({
  version: 2,
  type: 'profile',
