...
$wgHooks['CreateTransaction'][] = 'TransactionManagerHooks::createTransaction';
# On Electronic Payment action
...
//        if (isset($tmr['tmr_id']) && is_int($tmr['tmr_id'])) {
...
//        # We are reading, but we need the master table anyway
//        $dbw = wfGetDB(DB_MASTER);
//        $result = $dbw->select('tm_record', '*', array('tmr_user_id' => $user_id, 'tmr_status'=>'PE','tmr_amount < 0'));
//        return $result;
//        
//    }
//    
...
//     * @return Int
//     */
//    public static function getBalanceFromDB($user_id, $conditions = null) {
//        $conditions = array_merge (array('tmr_user_id' => $user_id), $conditions);
...
//    
//    /** 
//     * Updates PEnding transactions after account credit
//     * @return TMRecord
//     */
//    public static function updatePendignTransactions($user_id) {
//        $result = self::getPendingTransactions($user_id);
//        
//        $conditions = array_merge (array('tmr_user_id' => $user_id), $conditions);
//        $dbr = wfGetDB(DB_SLAVE);
//        # @TODO: Remove TE(st) from conditions. Otherwise we count virtual money...
