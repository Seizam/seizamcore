...
abstract class HTMLFormField {
    ...
    function getTableRow($value) {
        ...
        $field = Html::rawElement(
                        'td', array('class' => 'mw-input') + $cellAttributes, $this->getInputHTML($value) . "\n$errors"
        );
    ...
    function getLabelHtml($cellAttributes = array()) {
        ...
        return Html::rawElement('td', array('class' => 'mw-label') + $cellAttributes, Html::rawElement('label', $for, $this->getLabel())
        );
    }
